...
def write_edit(fflt,ttrct):
    with open(r"./app/Edit_flt.txt", 'w') as f:
        f.writelines(fflt)
    with open(r"./app/Edit_trct.txt", 'w') as ff:
        ff.writelines(ttrct)
...
#Read Input File
Tractor = pd.read_excel(r"./app/Tractor.xlsx",index_col=0)
Last_tractor = pd.read_json (r'./app/Out.json')
Last_wp = pd.read_json (r'./app/df_das.json')
...
df_input = df_unique
ReqTimeInput = pd.read_csv(r'./app/ReqTime.txt', delimiter=';')
ReqTimeInput = ReqTimeInput.drop_duplicates(subset=['flight'], keep='last')
BayInput = pd.read_csv(r'./app/Bay.txt', delimiter=';')
BayInput = BayInput.drop_duplicates(subset=['flight'], keep='last')
EditfltInput2 = pd.read_csv(r'./app/fltpair.txt', delimiter=';')
...
with open(r'./app/datalock.txt', 'r') as fp:
    for line in fp:
...
#df_das.to_json(r'./app/df_das_update.json')
df_das.to_json(r'./app/df_das.json')

#Tractor_Out.to_json(r'./app/Tractor_Out.json')
Tractor_Out.to_json(r'./app/Out.json')
print("current time:-", dt.now())
df_das_raw.to_csv(r'./app/df_das_raw.csv')
df_das.to_csv(r'./app/df_das.csv')
Tractor_Out.to_csv(r'./app/Out.csv')
df_show = df_das[['flight_number','aircraft','bay','Time','Tractor']]
df_show.to_csv(r'./app/df_show.csv')
tractor_stat(Das_Out).to_csv(r'./app/Tractor_stat_out.csv')
Tractor_option.to_csv(r'./app/Tractor_option.csv')
Tractor_option2.to_csv(r'./app/Tractor_option2.csv')